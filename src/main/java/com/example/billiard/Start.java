    ...
    public void start(Stage primaryStage) {
        ...
        AnimationTimer timer = new AnimationTimer() {
            ...
            public void handle(long now) {
                ...
                game.update(); // Spiellogik aktualisieren
        ...
        canvas.heightProperty().addListener((obs, oldHeight, newHeight) -> {this.oldHeightHolder = oldHeight.doubleValue(); this.newHeightHolder = newHeight.doubleValue();});
        canvas.widthProperty().addListener((obs, oldWidth, newWidth) -> {this.oldWidthHolder = oldWidth.doubleValue(); this.newWidthHolder = newWidth.doubleValue();});
        ...
        canvas.setOnMouseReleased(event -> {
                ...
                double cuePower = game.calculateCuePower(game.cueStartX, game.cueStartY, cueEndX, cueEndY);

                // Setzen der Stoßkraft und Ausrichtung des Cue-Sticks
                game.cue.setPower(cuePower);
